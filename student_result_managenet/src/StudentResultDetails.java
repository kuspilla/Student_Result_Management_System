 ...
 * @author dasthu
 */
public class StudentResultDetails extends javax.swing.JFrame {

    /**
     * Creates new form StudentResultDetails
     */
    public StudentResultDetails() {
        initComponents();
    }
     public StudentResultDetails(String rollNumber) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student_result_managenet/previous.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentResultDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentResultDetails().setVisible(true);
            }
        });
    }
