...
public class AdminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Rigistered Students");
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student_result_managenet/logout.png"))); // NOI18N
        ...
        box1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "MBA", "BTech", "MTech", "BBA" }));
        ...
        box2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "EEE", "CS", "IT", "ECS", "Management", "Finance", "Marketing", "Others" }));
        ...
        box5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female", "Others" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(box2, 0, 119, Short.MAX_VALUE)
                            .addComponent(box4)
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
               ...
               String cource = (String)box1.getSelectedItem();
               String branchName = (String) box2.getSelectedItem();
               String rollno = (String) box3.getText();
               String name = (String) box4.getText();
               String genger = (String) box5.getSelectedItem();
               String fatherName = (String) box6.getText();
               ...
               st.executeUpdate("insert into student(rollno,cource,branchName,name,gender,fatherName) values('"+rollno+"','"+cource+"','"+branchName+"','"+name+"','"+genger+"','"+fatherName+"')");
